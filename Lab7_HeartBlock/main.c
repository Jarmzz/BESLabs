...
#define VT											(*((volatile unsigned long *)0x40025008))//PF1
#define READY										(*((volatile unsigned long *)0x40025020))//PF3
#define AS											(*((volatile unsigned long *)0x40025040))//PF4
